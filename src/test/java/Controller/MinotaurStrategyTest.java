...
public class MinotaurStrategyTest {
    ...
    public void setUp(){
        ...
        context.selectStrategy("MINOTAUR");
    ...
    @Test
    public void moveWithMinotaurPush_Test(){
        ...
        assertEquals(player_1.getWorker(0),game.getBoardGame().getBoardWorker(0,2));
    }

    @Test
    public void moveWithMinotaurAthena_Test(){
        game.buildTo(1,1,1);
